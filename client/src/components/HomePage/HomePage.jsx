...
const ShowResultText = ({ searching }) => {
  return (
    <div className="flex gap-3">
      ...
      {searching && (
        <div role="status">
          <svg
            aria-hidden="true"
            className="inline w-5 md:w-6 h-5 md:h-6 mr-2 text-gray-200 animate-spin dark:text-gray-600 fill-blue-600"
            viewBox="0 0 100 101"
            fill="none"
    ...
    <div className="container mx-auto text-white mt-20 px-5 my-40">
      ...
      <div className="mt-10 md:mt-20">
        <h1 className="mb-5 text-xl md:text-2xl font-bold">
          {query ? (
            <ShowResultText searching={searching}/>
          ) : (
